            ...
            <div className="add-user-pg">
                ...
                <div className="add-details">
                    <div class="alert alert-success hidden" id="success-alert">
                        <button type="button" id="close-button" class="close">x</button>
                    ...
                    <div className="account-details">
                        ...
                        <form>
                            ...
                            <div class="text-left">
                                <button type="button" id="submit-button" class="btn btn-primary">Add New User</button>
                            </div>
                        </form>
                    </div>
