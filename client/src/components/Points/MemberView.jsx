...
const MemberView = ({
  ...
  //group1 is for signature events
  //group2 is for non-signature events

  var group1Goal = 3;
  var group2Goal = 2;
  var plcGoal = 1;

  var group1, group2, plc;

  if (pointsReport !== null && pointsReport !== undefined) {
    if (
      group1Points <= group1Goal - 3 ||
      pointsReport[user.uid] === undefined
    ) {
      group1 = (
    ...
    } else if (group1Points === group1Goal - 2) {
      group1 = (
        <div className="orange-block">
          <div className="pr-description">
            <h4>Group 1</h4>
            <span>2 Hour Remaining</span>
          </div>
        </div>
      );
    ...
    } else if (group2Points === group2Goal - 1) {
      group2 = (
        <div className="yellow-block">
          <div className="pr-description">
            <h4>Group 2</h4>
